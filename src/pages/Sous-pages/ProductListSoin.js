    ...
    return (
        <>
            ...
            <div style={{ height: "auto" }}>
                <center><h1> Annonces Soin et Pansement</h1></center>
                <div className='cards'>
                                        ...
                                        return (
                                            <ul className="cards__items">
                                                {data.slice(index, index + 3).map((row, index) => {
                                                    return row.Etat1Anononce == "Validé_Expert" && row.TypeAnnonce == "Annonce d'offre gratuit /Vente(Prix Symbolique)" && row.Catégorie == "NonMedicament" && row.TypeNonmedicament == "Soin et Pansement" ?
                                                        <AnnoncesItem
                                                            path="/SoinPansement"
                                                            pathBack="/SoinPansement"
                                                            id={row._id}
                                                            key={index}
