...
export default class GExpert extends React.Component {
  ...
  componentDidMount() {
    axios.get(`http://localhost:4000/expert/afficher`)
      .then(res => {
  ...
  convertirEnUser = (_id, record, e) => {
    ...
    axios.delete(`http://localhost:4000/expert/supprimer/${_id}`)
      .then(res => {
        console.log(res);
        console.log(res.data);
    ...
    axios.post(`http://localhost:4000/user/ajouter`, NExpert1)
      .then(res => {
        console.log(res);
        console.log(res.data);
